...
public class SameReducerGroup extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(SameReducerGroup.class);
		...
		job.setGroupingComparatorClass(MyGroupor.class);
	...
	public static void main(String[] args) throws Exception {
		...
		int exitCode = ToolRunner.run(new SameReducerGroup(), args);
